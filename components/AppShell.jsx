...
export default function AppShell({ activeTab, onTabChange, currency, onCurrencyChange, children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* ── Mobile bottom bar ── */}
      <div
        className="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-100 shadow-[0_-2px_12px_rgba(0,0,0,0.06)] flex items-center justify-around px-4 pt-2 pb-0"
